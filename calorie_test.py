...
class CalculatorTest(unittest.TestCase):
    ...
    def test_total_calorie_calculator(self):
        ...
        """
        result1 = calorie_calculation.total_calorie_calculator(
                  1502, "Sedentary: little or no exercise")
        result2 = calorie_calculation.total_calorie_calculator(
                  1655, "Lightly Active: light exercise 1-3 times/week")
        bmr_result = calorie_calculation.bmr_calculator(25, 'Female', 50, 166)
        result3 = calorie_calculation.total_calorie_calculator(
                  bmr_result,
                  "Moderately Active: light to moderate "
                  "exercise 4-5 times/week")
        result4 = calorie_calculation.total_calorie_calculator(
                  bmr_result,
                  "Active: moderate exercise 6-7 times/week or intense "
                  "exercise 3-4 times/week")
        result5 = calorie_calculation.total_calorie_calculator(
                  bmr_result,
    ...
    def test_carb_needs(self):
        ...
        total_calorie_1 = calorie_calculation.total_calorie_calculator(
                          1502,
...
class MainTest(unittest.TestCase):
    def test_checkbox_click(self):
        ...
        self.assertEqual(app.root.get_screen('calculator').gender,
